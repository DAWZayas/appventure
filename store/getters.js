...
export default {
  ...
  getDisplayName: state => state.userData ? state.userData.displayName : state.user.displayName,
  getParticipating: state => state.userData ? (state.userData.participating || {}) : {},
  getEmail: state => state.user ? state.user.email : '',
  getUserPhoto: state => state.userData ? state.userData.photoURL : state.user.photoURL,
